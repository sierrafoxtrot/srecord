...
srec_output_file_emon52::srec_output_file_emon52(const char *filename) :
...
srec_output_file_emon52::srec_output_file_emon52(const srec_output_file_emon52 &) :
	srec_output_file(),
	pref_block_size(16)
{
...
srec_output_file_emon52::write(const srec_record &record)
{
	...
	case srec_record::type_start_address:
		if (data_only_flag)
			break;
		put_stringf("00 %4.4lX:0000\n", record.get_address() & 0xFFFF);
		break;
...
int
srec_output_file_emon52::preferred_block_size_get()
	const
{
