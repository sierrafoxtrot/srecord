...
//      02110-1301 USA.
//
// MANIFEST: interface definition for include/srec/input/file/ti_txt.cc
//

#ifndef INCLUDE_SREC_INPUT_FILE_ti_txt_H
#define INCLUDE_SREC_INPUT_FILE_ti_txt_H
...
public:
    ...
    /**
      ...
      */
    srec_input_file_ti_txt(const string &file_name);
...
#endif // INCLUDE_SREC_INPUT_FILE_ti_txt_H
