...
srec_input_file_four_packed_code::srec_input_file_four_packed_code(const srec_input_file_four_packed_code &) :
	srec_input_file(),
	garbage_warning(false),
	seen_some_input(false),
	running_address(0)
...
srec_input_file_four_packed_code::srec_input_file_four_packed_code(const char *filename) :
...
srec_input_file_four_packed_code::operator=(const srec_input_file_four_packed_code &)
{
	fatal_error("bug (%s, %d)", __FILE__, __LINE__);
	return *this;
}
