...
#pragma implementation "srec_input_filter_checksum_negative"
...
srec_input_filter_checksum_negative::srec_input_filter_checksum_negative(const srec_input_filter_checksum_negative &arg)
...
srec_input_filter_checksum_negative::operator=(const srec_input_filter_checksum_negative &arg)
{
	if (this != &arg)
	{
