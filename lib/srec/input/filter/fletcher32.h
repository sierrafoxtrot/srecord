...
#ifndef LIB_SREC_INPUT_FILTER_FLETCHER32_H
#define LIB_SREC_INPUT_FILTER_FLETCHER32_H

#include <lib/fletcher32.h>
#include <lib/endian.h>
#include <lib/srec/input/filter.h>
#include <lib/srec/memory.h>

/**
  * The srec_input_filter_fletcher32 class is used to represent the state of
  * a checksum filter that inserts an Fletcher 32 checksum into the data.
  */
class srec_input_filter_fletcher32:
...
public:
    /**
      * The destructor.
      */
    virtual ~srec_input_filter_fletcher32();
...
private:
    /**
      ...
      *     The byte order.
      */
    srec_input_filter_fletcher32(const srec_input::pointer &deeper,
...
private:
    ...
    /**
      ...
      * order to calculate the Fletcher 32 checksum, and the input may be
    ...
    /**
      ...
      * whether we have returned the Fletcher 32 checksum to our reader yet.
      */
    ...
    /**
      ...
      */
    srec_input_filter_fletcher32();

    /**
      * The copy constructor.  Do not use.
      */
    srec_input_filter_fletcher32(const srec_input_filter_fletcher32 &);

    /**
      * The assignment operator.  Do not use.
      */
    srec_input_filter_fletcher32 &operator=(
        const srec_input_filter_fletcher32 &);
};

// vim:ts=8:sw=4:et
#endif // LIB_SREC_INPUT_FILTER_FLETCHER32_H
