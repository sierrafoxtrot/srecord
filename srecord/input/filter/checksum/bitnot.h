...
public:
    /**
      * The destructor.
      */
    ~input_filter_checksum_bitnot() override;
...
public:
    /**
      ...
      *     that width, no provision for an offset is provided.
      */
    static auto create(const input::pointer &deeper, int address,
        int length, endian_t end, int width = 1) -> pointer;
...
private:
    ...
    /**
      ...
      */
    auto operator=(
            const input_filter_checksum_bitnot &) -> input_filter_checksum_bitnot & = delete;
};
