...
public:
    /**
      * The destructor.
      */
    ~input_filter_message_adler32() override;
...
public:
    /**
      ...
      *     The byte order.
      */
    static auto create(const input::pointer &deeper,
        unsigned long address, endian_t end) -> pointer;
...
private:
    ...
    /**
      ...
      */
    auto operator=(
        const input_filter_message_adler32 &) -> input_filter_message_adler32 & = delete;
};
