...
#
# MANIFEST: Test the ascii-hex functionality
#
here=`pwd`
...
fail()
{
        cd $here
        rm -rf $work
        echo 'FAILED test of the ascii-hex functionality'
        exit 1
}
...
no_result()
{
        cd $here
        rm -rf $work
        echo 'NO RESULT for test of the ascii-hex functionality'
        exit 2
}
...
$bin/srec_cat test.in -o test.out -ah -data-only > LOG 2>&1
