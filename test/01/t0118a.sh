...
#
# MANIFEST: Test the output -asm -cl430 functionality
#
here=`pwd`
...
fail()
{
        cd $here
        rm -rf $work
        echo 'FAILED test of the output -asm -cl430 functionality'
        exit 1
}
...
no_result()
{
        cd $here
        rm -rf $work
        echo 'NO RESULT for test of the output -asm -cl430 functionality'
        exit 2
}
...
$bin/srec_cat test.in -o test.out -asm -cl430 > LOG 2>&1
