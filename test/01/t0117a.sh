...
#
# MANIFEST: Test the output -asm -a430 functionality
#
here=`pwd`
...
fail()
{
        cd $here
        rm -rf $work
        echo 'FAILED test of the output -asm -a430 functionality'
        exit 1
}
...
no_result()
{
        cd $here
        rm -rf $work
        echo 'NO RESULT for test of the output -asm -a430 functionality'
        exit 2
}
...
$bin/srec_cat test.in -o test.out -asm prefix -a430 > LOG 2>&1
