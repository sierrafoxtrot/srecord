...
fail()
{
        cd $here
        rm -rf $work
        echo 'FAILED test of the hexdump functionality'
        exit 1
}
...
no_result()
{
        cd $here
        rm -rf $work
        echo 'NO RESULT for test of the hexdump functionality'
        exit 2
}
...
$bin/srec_cat test.in -bin -exclude 0x08 0x0D 0x2a 0x37 -o test.out -hexdump
