...
#
# MANIFEST: Test the TI-Tagged functionality
#
here=`pwd`
...
fail()
{
        cd $here
        rm -rf $work
        echo 'FAILED test of the TI-Tagged functionality'
        exit 1
}
...
no_result()
{
        cd $here
        rm -rf $work
        echo 'NO RESULT for test of the TI-Tagged functionality'
        exit 2
}
...
$bin/srec_cat test.in -tit -o test.out -header HDR
