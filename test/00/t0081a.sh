...
#
# MANIFEST: Test the BASIC functionality
#
here=`pwd`
...
fail()
{
        cd $here
        rm -rf $work
        echo 'FAILED test of the BASIC functionality'
        exit 1
}
...
no_result()
{
        cd $here
        rm -rf $work
        echo 'NO RESULT for test of the BASIC functionality'
        exit 2
}
...
$bin/srec_cat test.in -o test.out -basic
