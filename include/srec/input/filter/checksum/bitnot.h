...
#pragma interface "srec_input_filter_checksum_bitnot"
...
public:
	...
	srec_input_filter_checksum_bitnot(srec_input *deeper, int address,
...
private:
	...
	srec_input_filter_checksum_bitnot(const srec_input_filter_checksum_bitnot &);
	srec_input_filter_checksum_bitnot &operator=(const srec_input_filter_checksum_bitnot &);
};
