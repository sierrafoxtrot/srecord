 ...
 *
 * MANIFEST: interface definition for include/srec/input/file/four_packed_code.cc
 */

#ifndef INCLUDE_SREC_INPUT_FILE_FOUR_PACKED_CODE_H
#define INCLUDE_SREC_INPUT_FILE_FOUR_PACKED_CODE_H

#pragma interface "srec_input_file_four_packed_code"
...
/**
  ...
  */
class srec_input_file_four_packed_code: public srec_input_file
{
public:
	/**
	  * The default constructor.  The input will be read fromn the
	  * standard input.
	  */
