...
#pragma interface "srec_output_file_dec_binary"

#include <srec/output/file.h>

/**
  * The srec_output_file_mos_tech class is used to write a DEC Binary
  * (XXDP) formatted file.
  */
...
public:
	...
	/**
	  ...
	  */
	srec_output_file_dec_binary(const char *filename);
